...
void SDFMap::initMap(ros::NodeHandle& nh) {
  ...
  node_.param("sdf_map/fx", mp_.fx_, 387.229248046875);
  node_.param("sdf_map/fy", mp_.fy_, 387.229248046875);
  node_.param("sdf_map/cx", mp_.cx_, 321.04638671875);
  node_.param("sdf_map/cy", mp_.cy_, 243.44969177246094);
