...
class vehicle_pose_and_velocity_updater:
	...
	def __init__(self):
		rospy.init_node('scout_odom_tf2', log_level=rospy.DEBUG)
		if rospy.has_param('/publish_robot2/robot_namespace'):
			self.rname = rospy.get_param('/publish_robot2/robot_namespace')
		...
		self.odom_pub1 = rospy.Publisher('/target_odom', Odometry, queue_size = 1) #for grid_map
	...
	def pubModelstate(self, timer):
		...
		self.odom_pub1.publish(self.odom_)
